...
// package web3ext contains sdvn specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
        ...
        new web3._extend.Method({
			name: 'getFulBalAtNumber',
			call: 'alien_getFulBalAtNumber',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getFulBalance',
			call: 'alien_getFulBalance',
			params: 1
		}),
        new web3._extend.Method({
			name: 'getFulBalanceAtNumber',
			call: 'alien_getFulBalanceAtNumber',
			params: 2
		}),
	]
});
